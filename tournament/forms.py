...
class TournamentForm(forms.ModelForm):
    class Meta:
        model = Tournament
        fields = [
            'name', 'start_date', 'end_date', 'location', 'surface',
            'sponsor', 'entry_fee', 'prize_money', 'category',
            'description', 'max_participants', 'img_url', 'phone_number',
            'email'
            ]
        widgets = {
            ...
            'description': forms.TextInput(
                attrs={'placeholder': 'Max. characters 400'}),
        }
